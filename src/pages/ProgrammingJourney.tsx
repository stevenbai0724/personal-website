...
const ProgrammingJourney = () =>{
    ...
    <div>
        ...
        <h3 className = {classes.h3}>If you know people who are studying or already working in computer science, chances are that you will have heard about the money they make. It is acceptable to be jealous of that and I've also been there before. However, it is important to remember that you often don't see the work put into success of other people and it will be misleading to think that choosing to pursue computer will guarantee a huge salary. The process is rough and you need patience, hard work and genuine interest to be a strong candidate for top-tier tech companies. I find that many of my peers are interested in the money, rather than computer science itself.</h3> 
        <br></br>
        <br></br>  
        ...
        <h3 className = {classes.h3}>I would say that I started programming at a fairly early time, it was the second semester of grade 9. I was in the pre-IB program (basically just a speicalized program full of try-hards) and at my school we had the privilege to start the grade 10 course a year in advance (ICS2O) . We covered the fundamentals in Python, HTML & CSS and I ended up making a simple pong game and a website. I loved this class because it sparked my interest and gave me a huge head start in coding. I was always hopping on the bandwagon by saying that I wanted to do computer science for post-secondary, but after this experience I had the genuine interest.</h3> 
        ...
        <h3 className = {classes.h3}> Grade 10 programming class went smoothly for the most part, we began learning the grade 11 course which was in Java (ICS3U). For the final project we had to code a game with a Java GUI from scratch. Most of us were very underprepared for this because we were not taught much of GUI in Java and most of it required self-guided learning and countless hours of stack overflow. The deadline was approaching after winter break and I still could not get a functioning project. </h3>
        <br></br>
        <br></br>   
        <h3 className = {classes.h3}>I’m not trying to justify myself, but because of this obstacle I tried to copy code from an existing project on stack overflow and alter it so I can have a functioning project. Unfortunately the teachers have been in this game for many years and they have sophisticated plagiarism detection even in coding and I was caught red handed. That was not a fun experience, but certainly an important one especially for anyone reading this who wishes to create software projects in the future. </h3> 
        <br></br>
        <br></br>
        <h3 className={classes.h3}>The consequences would have been very serious in higher levels of education but I had this warning early in grade 10. I was given 3 days to redo the project since I had performed relatively well throughout the course and not a big portion of the project was copied. I ended up with an 86 in the course. I would say that myself in grade 10 wasn’t very academically focused anyways (I was getting mid 80s on average) so this was a huge wake up call. A year later in grade 11, I took the final course (ICS4U) and having all the knowledge and experience from before I passed effortlessly with a 100 in the course.</h3>
        
        <h2 className = {classes.h2Title}>Competitive Programming (CP)</h2>

        <h3 className = {classes.h3}>I started consistenly solving problems on <a className = {classes.a} href="https://dmoj.ca" target="_blank">DMOJ</a> in grade 11 but I wish I started earlier when I began learning Python in grade 9, and I would encourage anyone who wants to start coding to create an account on DMOJ and begin learning what competitive programming is. I highly recommend spending 15 mins to watch these videos which explains CP to a complete beginner. </h3>
        <br></br>
        <br></br>
        ...
        <h3 className = {classes.h3}><a href = "https://dmoj.ca/problem/helloworld" target="_blank" className = {classes.a}> helloworld, </a> </h3>
        <h3 className = {classes.h3}><a href = "https://dmoj.ca/problem/aplusb" target="_blank" className = {classes.a}>aplusb, </a> </h3>
        <h3 className = {classes.h3}><a href = "https://dmoj.ca/problem/ccc13j1" target="_blank" className = {classes.a}>ccc13j1, </a> </h3>    
        <h3 className = {classes.h3}><a href = "https://dmoj.ca/problem/vpex1p0" target="_blank" className = {classes.a}>vpex1p0.</a></h3>
