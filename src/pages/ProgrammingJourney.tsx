...
const ProgrammingJourney = () =>{
    ...
    <div className={classes.mainContainer}>
        ...
        <AnimationOnScroll offset = {100} duration = {0.5} animateOnce={true} animateIn="animate__fadeInUp">
            <h3 className = {classes.h3}>Computer programming is a huge field of study that is becoming more and more popular in recent years. Many students who are my age (currently 17 years old) are constantly striving and working towards getting into a top computer science undergrad program in hopes of making a lot of money after graduation. Computer science is a highly competitive field! There are certainly younger or inexperienced audiences who merely have aspirations and have never written a single line of code before. That being said, I will share some of the advice from my programming journey I wish I knew earlier.</h3>
        </AnimationOnScroll>
