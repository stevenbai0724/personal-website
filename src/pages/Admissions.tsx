...
const Admissions = () =>{ 
  ...
  return (
    <div style={{width: "100%"}}>
        ...
        <AnimationOnScroll duration = {0.5} animateOnce={true} animateIn="animate__fadeInUp">
