        ...
        <div >
            ...
            <Grid item >
                    <Paper className = {classes.paper}>
                        ...
                        <Paper className = {classes.tech}><ButtonBase className = {classes.btnBase}> React.js </ButtonBase>,<ButtonBase className = {classes.btnBase}> Express.js</ButtonBase>, <ButtonBase className = {classes.btnBase}> Node.js</ButtonBase></Paper>
